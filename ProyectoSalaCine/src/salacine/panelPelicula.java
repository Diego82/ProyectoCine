...
public class panelPelicula {
	...
	private  void crearHoras() {
		...
		for (int i = 0; i < horasArray.length; i++) {
			...
			/*listaHoras.add(hora.getRadioBoton());

			panel_2ArribaDetalle.add(hora.getRadioBoton());
			if (i ==0||i == 1 || i ==2|| i ==3) {
				JLabel label = new JLabel("");
				panel_2ArribaDetalle.add(label);
			}*/
			
			
			
			/*hora.getRadioBoton().addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent arg0) {
					// TODO Auto-generated method stub
					//para saber cual tocas
					if(hora.getRadioBoton().getText().contentEquals("16:00")){
						crearSala();
					}
					//llamar a pintarSala
					//crearSala();
					...
					System.out.println("ENTRA AL ESCUCHADOR");
					switch (hora.getRadioBoton().getText()) {
					case "16:00":
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.TRAILING, false)
						...
						.addComponent(panel_3AbajoDetalle, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 544, Short.MAX_VALUE))
		...
		gl_panel.setVerticalGroup(
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addComponent(panel_2ArribaDetalle, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
		...
		gl_panel_1.setVerticalGroup(
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addComponent(etiquetaImagen)
					.addGap(18)
					.addComponent(etiquetaSpnosis, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(btnNewButton_1)
